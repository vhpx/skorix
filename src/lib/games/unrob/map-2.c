...
const Position map_2_map_wall_boundaries[] = {
    {.x = 440, .y = 998}, {.x = 440, .y = 890}, {.x = 435, .y = 890},
    {.x = 435, .y = 925}, {.x = 375, .y = 925}, {.x = 375, .y = 975},
    {.x = 60, .y = 975},  {.x = 60, .y = 795},  {.x = 105, .y = 795},
    {.x = 105, .y = 765}, {.x = 105, .y = 765}, {.x = 60, .y = 765},
    {.x = 60, .y = 675},  {.x = 120, .y = 675}, {.x = 120, .y = 650},
    {.x = 60, .y = 650},  {.x = 60, .y = 545},  {.x = 120, .y = 545},
    {.x = 120, .y = 490}, {.x = 60, .y = 490},  {.x = 60, .y = 380},
    {.x = 100, .y = 380}, {.x = 100, .y = 360}, {.x = 60, .y = 360},
    {.x = 60, .y = 270},  {.x = 120, .y = 270}, {.x = 120, .y = 250},
    {.x = 60, .y = 250},  {.x = 60, .y = 180},  {.x = 215, .y = 180},
    {.x = 215, .y = 240}, {.x = 250, .y = 240}, {.x = 250, .y = 180},
    {.x = 330, .y = 180}, {.x = 330, .y = 240}, {.x = 360, .y = 240},
    {.x = 360, .y = 195}, {.x = 360, .y = 195}, {.x = 400, .y = 195},
    {.x = 400, .y = 230}, {.x = 450, .y = 230}, {.x = 450, .y = 180},
    {.x = 535, .y = 180}, {.x = 535, .y = 235}, {.x = 605, .y = 235},
    {.x = 605, .y = 190}, {.x = 695, .y = 190}, {.x = 695, .y = 250},
    {.x = 880, .y = 250}, {.x = 880, .y = 275}, {.x = 930, .y = 275},
    {.x = 930, .y = 360}, {.x = 930, .y = 360}, {.x = 900, .y = 360},
    {.x = 900, .y = 390}, {.x = 930, .y = 390}, {.x = 930, .y = 625},
    {.x = 885, .y = 625}, {.x = 885, .y = 670}, {.x = 930, .y = 670},
    {.x = 930, .y = 760}, {.x = 930, .y = 760}, {.x = 895, .y = 760},
    {.x = 895, .y = 780}, {.x = 930, .y = 780}, {.x = 930, .y = 840},
    {.x = 750, .y = 840}, {.x = 750, .y = 980}, {.x = 615, .y = 980},
    {.x = 615, .y = 915}, {.x = 690, .y = 880}, {.x = 690, .y = 850},
    {.x = 635, .y = 850}, {.x = 635, .y = 915}, {.x = 635, .y = 915},
    {.x = 555, .y = 925}, {.x = 555, .y = 890}, {.x = 550, .y = 890},
    {.x = 550, .y = 998}, {.x = 440, .y = 998},
};
