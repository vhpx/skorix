...
// RPI3
#define IRQ_PENDING_BASE    (*(volatile unsigned int *)(INTERRUPT_BASE + 0x200))
...
#define IRQ_ENABLE_1        (*(volatile unsigned int *)(INTERRUPT_BASE + 0x210))
#define IRQ_ENABLE_2        (*(volatile unsigned int *)(INTERRUPT_BASE + 0x214))
#define IRQ_ENABLE_BASE     (*(volatile unsigned int *)(INTERRUPT_BASE + 0x218))
#define IRQ_DISABLE_1       (*(volatile unsigned int *)(INTERRUPT_BASE + 0x21C))
#define IRQ_DISABLE_2       (*(volatile unsigned int *)(INTERRUPT_BASE + 0x220))
#define IRQ_DISABLE_BASE    (*(volatile unsigned int *)(INTERRUPT_BASE + 0x224))
